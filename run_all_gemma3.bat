@echo off
echo Starting comprehensive evaluation for Gemma3-4B model
...
echo Check SLM_Results/gemma3_4b/ for detailed results
echo.
echo To run with different number of questions, use:
echo python slm_runner.py --model gemma3_4b --all --num_questions 10
echo python slm_runner.py --model gemma3_4b --all --num_questions 100
pause